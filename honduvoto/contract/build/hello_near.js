...
let VotingContract = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = call({}), _dec7 = call({}), _dec8 = view(), _dec9 = view(), _dec10 = view(), _dec11 = view(), _dec12 = view(), _dec13 = view(), _dec(_class = (_class2 = class VotingContract {
  ...
  userParticiptaion = new UnorderedMap("userParticipation");
  ...
  recordUser({
    ...
    let currentArray = this.userParticiptaion.get(prompt, {
      defaultValue: []
    });
  ...
  didParticipate({
    ...
    let promptUserlist = this.userParticiptaion.get(prompt, {
      defaultValue: []
    });
...
function participaationArray() {
  ...
  const _args = VotingContract._getArgs();
  const _result = _contract.participaationArray(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(VotingContract._serialize(_result, true));
}
...
export { addCandidatePair, addToPromptArray, addVote, clearPromptArray, didParticipate, getAllPrompts, getCandidatePair, getUrl, getVotes, initializeVotes, participaationArray, recordUser };
